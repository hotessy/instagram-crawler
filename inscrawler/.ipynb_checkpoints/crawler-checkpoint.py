...
#         print(secret.username)
    ...
    def get_location_posts_by_time(self,location,date,num):
        location_name=location
        try:
            location_id=metros.metro[location]
        except:
            print('location not present')
            return
        
        url=dateToId.run('https://www.instagram.com/explore/locations/'+location_id+'/'+location_name,date)
